...
** TODO in sample_tables.py, after making geo_sample, not all geo areas are there
This is visible from the two big tables that get written, before the little pivots.

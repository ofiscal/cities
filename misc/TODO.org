...
** TODO Rewrite filtering in build/ stage 1p5
Use classify_budget_codes.of_interest to filter 
funccionamiento and inversion rows.

Use the regex in select_budget_codes.py to select ingresos rows.
** TODO Replace "item code" with "item categ".
Use classify_budget_codes for inversion and funccionamiento.

For ingresos, implement these:
TI.A - TI.A.2.6 = "ingresos por recursos propios"
TI.A.2.6 = "ingresos por transferencias de la Nación"

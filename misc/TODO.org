* TODO check local on Ubuntu
Just run `locale` from bash:
...
* TODO draw charts
** TODO bug -- demo works but main doesn't
*** TODO this seems like the problem
The good one has a verbal index,
                 meaningful column names
                 entirely numeric values
The bad one has none of those.
*** where
Code/draw/demo/plot_fake_data.py # good
Code/main.py                     # bad
** TODO all: decide: what kinds of charts to draw
...
* TODO fix
** TODO add use_keys.py to Makefile (as a dependency)

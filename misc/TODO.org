...
* TODO bughunt -- duplicate rows
Try collecting all years, see if the same solutions holds.
Look at higher percentile values -- 99.9, 99.99, etc.
Look at the rows that duplicate.

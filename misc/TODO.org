...
buget_7: what is the ingresos row with a NaN category?
  and why is it only there for the muni, not the dept?
** TODO more
...
*** look at regalias
*** Use places where multiple funcionamiento codes are summed for infrastructure spending
*** Use 2013
...
* TODO add regalias to departments
* TODO draw charts

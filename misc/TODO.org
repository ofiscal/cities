...
* TODO FIRST
** TODO FIRST : solve 90 row bug
continue bughunt: 90 missing rows
  rule out a lot of corner cases** TODO SECOND : send tables to Manuela
*** tax categories
...
** group funcionamiento (as a single category) and inversion into gastos
** add regalias
** shrink numbers
*** fewer digits
*** smaller font

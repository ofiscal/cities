...
* TODO enlist Caoba to record streaming audio
** talk to Fancisco
Adri sent me contact over Whatsapp
** Alejo has list of websites to record
* TODO draw charts
** TODO in flux: "salarios" category
I sent Juan:
"Do we need to delete the category "Salario alcalde, gobernador, concejales, diputados"? If so, what should the codes "1.1.1.12" and "1.1.1.6" fall under?"
https://mail.google.com/mail/u/0/#search/from%3Ajuan/FMfcgxwDqxQdJsCXWHVVHWXrXHnSHWpl
** TODO add time series charts for health, edu, security
also seem nice: Infraestructura, pensions

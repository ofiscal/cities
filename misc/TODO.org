...
*** test changes in row numbers
*** budget item aggregation looks good
I compared these to the aggregate results from budget_3.
infrastructure codes in budget_2:
  for Antioquia:
    '1.3.11' = 0
    'A.15' = 6.581700e+10
    'A.7' = 3.091706e+10
...
*** Use 2013, edu (rather than infra) codes
it requires both deflation and scaling by 1000
And if needed, switch to a place where multiple funcionamiento codes are summed for infrastructure spending

...
if True: # define map from aggregate categories to the codes comprising them
  ...
  if True: # for the funcionamiento files
    ...
    categs_to_codes[t.funcionamiento][t.personal] = {
      "1.1.1.1", "1.1.1.10", "1.1.1.14", "1.1.1.2",
      "1.1.1.25", "1.1.1.3", "1.1.1.4", "1.1.1.5",
      "1.1.1.7.1", "1.1.1.8", "1.1.1.9", "1.1.2",
      "1.1.3.1", "1.1.3.2", "1.1.3.3", "1.1.3.4",
      "1.1.3.5", "1.1.3.6", "1.1.3.7", "1.1.3.8",
      "1.1.4.1.1.1.1", "1.1.4.1.1.1.2", "1.1.4.1.1.1.3", "1.1.4.1.1.1.4",
      "1.1.4.1.1.3.1", "1.1.4.1.1.3.2", "1.1.4.1.1.4.1", "1.1.4.1.1.4.2",
      "1.1.4.2.1.1.1", "1.1.4.2.1.1.2", "1.1.4.2.1.1.3", "1.1.4.2.1.1.4",
    ...
    categs_to_codes[t.funcionamiento][t.gen] = {
      ...
      "1.2.2.10", "1.2.2.11", "1.2.2.12.1", "1.2.2.12.2",
      "1.2.2.12.5", "1.2.2.19", "1.2.2.2", "1.2.2.3.1",
      "1.2.2.3.2.1", "1.2.2.3.2.2", "1.2.2.3.2.3", "1.2.2.3.2.5",
      "1.2.2.3.2.9", "1.2.2.3.3", "1.2.2.3.4", "1.2.2.3.5",
      "1.2.2.4", "1.2.2.5", "1.2.2.6.1", "1.2.2.6.2",
      "1.2.2.6.3", "1.2.2.6.4", "1.2.2.6.5", "1.2.2.7",
      "1.2.2.8.1", "1.2.2.8.2", "1.2.2.8.3", "1.2.2.9",
      "1.2.4", "1.2.9", "1.3.22", "1.3.10",
      "1.3.13", "1.3.14", "1.3.15", "1.3.18.1",
      "1.3.18.2", "1.3.18.3", "1.3.18.4", "1.3.19",
      "1.3.23", "1.3.24", "1.3.25", "1.3.6.5",
      "1.3.6.6", "1.3.6.7.10", "1.3.7", "1.4.1",
      "1.4.2", "1.4.3", "1.9.2.1", "1.9.2.2",
      "1.9.2.3", "1.9.2.4", "1.9.2.5", "1.9.2.6",
      "1.9.2.7", "1.9.2.8", "1.9.3", "1.9.4"
      }

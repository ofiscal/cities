...
def drawLastPage( pdf ):
  ...
  plt.text(
    ...
    "\n".join( [
      ...
      "La diferencia entre los ingresos y los gastos se debe a que en la estimación de gastos anuales de las entidades",
      " territoriales usamos los datos de gastos reportados como ejecutados. El dinero que no se ejecuta",
      "generalmente es devuelto a la Secretaría de Hacienda o se pone en una reserva para el siguiente año."] ),
    color = "white",
    fontproperties = design.font_thin,
    fontsize = design.sizeText_lastPageAbove,
    horizontalalignment="center" )
